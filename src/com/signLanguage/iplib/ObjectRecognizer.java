...
public class ObjectRecognizer {
    ...
    public static final double RATIO_TEST_RATIO =5;
    ...
    /**
     * TRAIN THE SYSTEM FOR RECOGNITION, IT READS THE FILE FROM SPECIFIED
     * DIRECTORY CALCULATE THE DESCRIPTOR AND KEYPOINTS USING ORB ALGORITHM
     *
     * @param trainDir
     */
     ...
     * have been recognized if nmax > minNumMatches. if for a query descriptor
     * there exists multiple matches to train descriptors of the same train
     * image, all such matches are counted as only one match. returns the name
     * of the object detected, or "-" if no object is detected.
     *
     * @param matches
     * @param minNumMatches
     * @return
